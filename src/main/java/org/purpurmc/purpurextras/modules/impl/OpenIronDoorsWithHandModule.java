 ...
 */
public class OpenIronDoorsWithHandModule implements PurpurExtrasModule {

    private final boolean doors, trapdoors;

    protected OpenIronDoorsWithHandModule() {
        doors = getConfigBoolean("settings.gameplay-settings.open-iron-doors-with-hand", false);
        trapdoors = getConfigBoolean("settings.gameplay-settings.open-iron-trapdoors-with-hand", false);
    }
    ...
    public String getConfigPath() {
        return "settings.gameplay-settings.open-iron-doors-with-hand";
    }
