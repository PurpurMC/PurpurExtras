...
public class DispenserBlocks extends PurpurExtrasModule {
    ...
    public DispenserBlocks(PurpurConfig config) {
        ...
        breakBlockAxe = getConfigBoolean("settings.dispenser.break-blocks.axe", false);
        breakBlockShears = getConfigBoolean("settings.dispenser.break-blocks.shears", false);
        shearPumpkin = getConfigBoolean("settings.dispenser.shears-shear-pumpkin", false);
